...
pub struct Block {
    pub min_corner: Vec3, // Esquina inferior del bloque
    pub max_corner: Vec3, // Esquina superior del bloque
    pub material: Material,
}

impl RayIntersect for Block {
    fn ray_intersect(&self, ray_origin: &Vec3, ray_direction: &Vec3) -> Intersect {
        // Calcular los valores de t para cada eje (x, y, z)
        ...
        // Calcular los valores de entrada y salida más grandes y más pequeños
        ...
        // Encontrar los valores de entrada y salida más grandes y más pequeños
...
impl Block {
    fn get_normal(&self, point: &Vec3) -> Vec3 {
        // Calcular la normal en función de la cara del bloque intersectada
